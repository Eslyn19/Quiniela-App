...
// Context en react: Permite compartir estado y datos entre componentes sin 
// necesidad de pasar props manualmente en cada nivel.
export function AdminProvider({ children }) {
    ...
    // Genera los headers de las peticiones HTTP incluyendo el token de autenticación almacenado en localStorage
    const getHeaders = useCallback(() => ({
        'Content-Type': 'application/json',
        Authorization: `Bearer ${localStorage.getItem('token')}`,
    }), []);

    // Cierra la sesión eliminando el token almacenado y redirigiendo al usuario a la página principal
