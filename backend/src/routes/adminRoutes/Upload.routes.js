...
// Ruta al backend/uploads/premios
...
// Configuración de Multer para almacenamiento y validación de archivos
...
// Filtro para aceptar solo imágenes y limitar tamaño a 5MB
const upload = multer({
    storage,
